...
import { idlFactory } from './isTrueCaller_backend.did.js';
export { idlFactory } from './isTrueCaller_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ISTRUECALLER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./isTrueCaller_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the isTrueCaller_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./isTrueCaller_backend.did.js")._SERVICE>}
 */
export const isTrueCaller_backend = createActor(canisterId);
