...
import { idlFactory } from './isTrueCaller_frontend.did.js';
export { idlFactory } from './isTrueCaller_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ISTRUECALLER_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./isTrueCaller_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the isTrueCaller_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./isTrueCaller_frontend.did.js")._SERVICE>}
 */
export const isTrueCaller_frontend = createActor(canisterId);
